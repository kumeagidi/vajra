...
from sarathi._model_executor_C.model_executor import (
    RowParallelLinear as RowParallelLinearC,
)
from sarathi._model_executor_C.model_executor import (
...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if use_native_execution_backend:
            self.native_handler = VocabParallelEmbeddingC(
                self.num_embeddings,
                self.embedding_dim,
                self.tensor_model_parallel_size,
                self.rank,
    ...
    def forward(self, input_):
        if self.use_native_execution_backend:
            return self.native_handler.forward(input_)
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if use_native_execution_backend:
            self.native_handler = ColumnParallelLinearC(
                self.input_size,
                self.output_size,
                self.gather_output,
                self.world_size,
...
class RowParallelLinear(torch.nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if use_native_execution_backend:
            self.native_handler = RowParallelLinearC(
                self.input_size,
                self.output_size,
