...
class Sampler(nn.Module):
    ...
    def forward(
        ...
        if (
            len(seq_metadata_list) == 1
            and seq_metadata_list[0].is_prompt
            and seq_metadata_list[0].prompt_chunk_len
            + seq_metadata_list[0].seq.get_num_prompt_tokens_stage_processed()
            != seq_metadata_list[0].seq.get_prompt_len()
        ):
            return [
                SamplerOutput(
