...
def create_attention_wrapper(*args, **kwargs):
    if ATTENTION_BACKEND == AttentionBackend.FLASHINFER:
        return FlashinferAttentionWrapper.create_instance(*args, **kwargs)
    elif ATTENTION_BACKEND == AttentionBackend.NO_OP:
        return NoOpAttentionWrapper.create_instance(*args, **kwargs)
