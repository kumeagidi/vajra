...
from sarathi._model_executor_C.model_executor import LlamaAttention as LlamaAttentionC
from sarathi._model_executor_C.model_executor import (
    LlamaDecoderLayer as LlamaDecoderLayerC,
)
from sarathi._model_executor_C.model_executor import LlamaMLP as LlamaMLPC
from sarathi._model_executor_C.model_executor import LlamaModel as LlamaModelC
    ...
    def __init__(
        ...
        if use_native_execution_backend:
            self.native_handle = LlamaAttentionC(
                ...
                get_attention_wrapper().native_handle,
            )
