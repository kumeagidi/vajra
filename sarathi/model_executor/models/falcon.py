...
class FalconAttention(nn.Module):
    ...
    def __init__(self, config: FalconConfig, layer_id: Optional[int] = None):
        super().__init__()
...
class FalconDecoderLayer(nn.Module):
    ...
    def __init__(self, config: FalconConfig, layer_id: Optional[int] = None):
        ...
        self.self_attention = FalconAttention(config, layer_id=layer_id)
        self.mlp = FalconMLP(config, layer_id=layer_id)
        self.config = config
...
class FalconModel(nn.Module):
    ...
    def __init__(self, config: FalconConfig):
        ...
        self.h = nn.ModuleList(
            [
                FalconDecoderLayer(config, layer_id=layer_id + layer_offset)
